  ...
  const projects = [
    {
      ...
      link: "https://github.com/theragini", // Replace with actual link if available
    },
    {
    ...
    },
    {
      ...
      link: "#", // Replace with Power BI link if any
    },
  ];
    ...
    <section id="projects" className="py-20 px-6 bg-gray-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {projects.map((proj, index) => (
          <div key={index} className="bg-gray-800 p-6 rounded-lg shadow hover:shadow-pink-500 transition">
            <h3 className="text-xl font-bold mb-2">{proj.title}</h3>
            <p className="mb-4">{proj.description}</p>
            <a href={proj.link} target="_blank" rel="noopener noreferrer" className="text-pink-300 underline">
              View Project
            </a>
          </div>
        ))}
